...
yukle_3proxy() {
    ...
    URL="https://github.com/mehmetarslann/CentOS_Proxy/raw/main/Paketler/3proxy-3proxy-0.8.6.tar.gz"
...
jq_yukle() {
    ...
    wget -qO jq https://github.com/mehmetarslann/CentOS_Proxy/raw/main/Paketler/jq-linux64
    chmod +x ./jq
    mv jq /usr/bin
}
...
echo -e "\n\n$sari Çalışma Dizini » /home/CentOS_Proxy_Yukle$renkreset"
YOL="/home/CentOS_Proxy_Yukle"
VERI="${YOL}/veri.txt"
mkdir -p $YOL && cd $_
